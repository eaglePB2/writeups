---
description: >-
  https://www.facebook.com/codingcompetitions/hacker-cup/2011/final-round/problems/B
icon: party-horn
---
...
The first line of the input consists of a single number **T**, the number of test cases. Each test case starts with a line containing three integers **N**, the number of nodes in **G**, **F**, the number of friends, and **M**, the number of edges in **G**. This is followed by **M** lines each containing two integers. The **i**th of these lines will contain two distinct integers **u** and **v** which indicates a mutual friendship between person **u** and person **v**. After this follows a single line containing **N** space-separated integers with the **i**th representing the amount of food consumed by person **i**.
